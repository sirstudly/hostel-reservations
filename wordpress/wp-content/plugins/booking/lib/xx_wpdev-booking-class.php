...
error_log($ds->toXml());
        ...
        //content of resources management page
        function content_of_resource_page_OLD(){
...
//////////////////////// END CUSTOM CODE ////////////////////////////
        ...
        // Get booking form
        function get_booking_form_action_OLD($my_boook_type=1,$my_boook_count=1, $my_booking_form = 'standard',  $my_selected_dates_without_calendar = '', $start_month_calendar = false) {
