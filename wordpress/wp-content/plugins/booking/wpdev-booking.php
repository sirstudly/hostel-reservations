...
//        { require_once(WPDEV_BK_PLUGIN_DIR. '/lib/wpdev-booking-class.php' ); }
    ...
    if (file_exists(WPDEV_BK_PLUGIN_DIR. '/include/validation_exception.class.php')) 
        { require_once(WPDEV_BK_PLUGIN_DIR. '/include/validation_exception.class.php' ); }

    if (file_exists(WPDEV_BK_PLUGIN_DIR. '/include/processing_exception.class.php')) 
        { require_once(WPDEV_BK_PLUGIN_DIR. '/include/processing_exception.class.php' ); }
    ...
    if (file_exists(WPDEV_BK_PLUGIN_DIR. '/include/lh_cleaner_tasks.class.php')) 
        { require_once(WPDEV_BK_PLUGIN_DIR. '/include/lh_cleaner_tasks.class.php' ); }

    if (file_exists(WPDEV_BK_PLUGIN_DIR. '/include/lh_cleaner_tasks_table.class.php')) 
        { require_once(WPDEV_BK_PLUGIN_DIR. '/include/lh_cleaner_tasks_table.class.php' ); }

    if (file_exists(WPDEV_BK_PLUGIN_DIR. '/include/lh_cleaner_tasks_table_row.class.php')) 
        { require_once(WPDEV_BK_PLUGIN_DIR. '/include/lh_cleaner_tasks_table_row.class.php' ); }

    if (file_exists(WPDEV_BK_PLUGIN_DIR. '/include/lh_cleaning_hours.class.php')) 
        { require_once(WPDEV_BK_PLUGIN_DIR. '/include/lh_cleaning_hours.class.php' ); }

    if (file_exists(WPDEV_BK_PLUGIN_DIR. '/include/lh_cleaning_hours_table.class.php')) 
        { require_once(WPDEV_BK_PLUGIN_DIR. '/include/lh_cleaning_hours_table.class.php' ); }

    if (file_exists(WPDEV_BK_PLUGIN_DIR. '/include/lh_cleaning_hours_table_row.class.php')) 
        { require_once(WPDEV_BK_PLUGIN_DIR. '/include/lh_cleaning_hours_table_row.class.php' ); }
