...
<xsl:template match="view">
    <xsl:choose>
        <xsl:when test="name = 'help'">
            <h2>Welcome!</h2>
            The following reports are automatically generated by "<a href="http://en.wikipedia.org/wiki/Web_scraping">scraping</a>" the reservations in Little Hotelier on a daily basis.
