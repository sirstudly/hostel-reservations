    ...
    <xsl:choose>
        <xsl:when test="editing = 'true'">
            <tr>
                ...
                <td><a class="btn btn-primary"><xsl:attribute name="onclick">save_blacklist(<xsl:value-of select="id"/>, document.post_option.edit_first_name.value, document.post_option.edit_last_name.value, document.post_option.edit_email.value); this.disabled=true;</xsl:attribute>Save</a>
        ...
        <xsl:otherwise>
            <tr>
                ...
                <td><a class="btn btn-primary"><xsl:attribute name="onclick">edit_blacklist(<xsl:value-of select="id"/>);</xsl:attribute>Edit</a> [Add Image] [Add Alias]</td>
            </tr>
        </xsl:otherwise>
    </xsl:choose>
</xsl:template>
